...
export function stableCanonicalJson(value: unknown): string {
  ...
  if (typeof value !== "string" && typeof value !== "number" && typeof value !== "boolean") throw new Error("canonical JSON contains an unsupported value");
...
export function computeRuntimeManifestDigest(payload: unknown): `sha256:${string}` {
  return `sha256:${sha256Utf8(stableCanonicalJson(payload))}`;
}
